...
local tabnine_status_ok, _ = pcall(require, "nvim.tabnine")
...
cmp.setup {
    ...
    formatting = {
        ...
        format = function(entry, vim_item)
            ...
            -- NOTE: order matters
            vim_item.menu =
                ({nvim_lsp = "", nvim_lua = "", luasnip = "", buffer = "", path = "", emoji = ""})[entry.source
                    .name]
            return vim_item
        end
    },
    sources = {
        ...
        {name = "emoji", group_index = 2}, {name = "lab.quick_data", keyword_length = 4, group_index = 2}
    },
    sorting = {
        priority_weight = 2,
        comparators = {
