...
M.winbar_filetype_exclude = {
    ...
    "dapui_breakpoints", "dapui_stacks", "dapui_watches", "dap-repl", "dap-terminal", "dapui_console", "lab",
    "Markdown", ""
}
...
M.get_filename = function()
    ...
    local f = require "nvim.functions"
...
--   end
--
--   if not require("nvim.functions").isempty(gps_location) then
--     return require("nvim.icons").ui.ChevronRight .. " " .. gps_location
--   else
--     return ""
--   end
-- end
...
M.get_winbar = function()
    ...
    if not f.isempty(value) and f.get_buf_option "mod" then
        local mod = "%#LspCodeLens#" .. require("nvim.icons").ui.Circle .. "%*"
        if gps_added then
            value = value .. " " .. mod
        else
            value = value .. mod
    ...
    if vim.fn.has "nvim-0.8" == 1 then
        vim.api.nvim_create_autocmd({
            ...
            callback = function()
                ...
                if not status_ok then require("nvim.winbar").get_winbar() end
            end
        })
    end
end
